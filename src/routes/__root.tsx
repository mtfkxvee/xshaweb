  ...
  head: () => ({
    meta: [
      ...
      { title: "X-SHA | Heritage of Tasikmalaya" },
      {
        name: "description",
        content:
          "X-SHA, ritel heritage Tasikmalaya sejak 2006. Katalog produk kurasi, promo member, dan 16+ outlet.",
      },
      { name: "author", content: "X-SHA" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      // Bricolage Grotesque, Plus Jakarta Sans, and Material Symbols are
      // self-hosted (bundled via styles.css @import from node_modules) so
      // the page never depends on a fonts.googleapis.com round trip.
